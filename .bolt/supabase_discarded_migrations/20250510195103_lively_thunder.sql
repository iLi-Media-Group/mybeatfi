/*
  # Custom Sync Requests Schema

  1. New Tables
    - `custom_sync_requests`
      - Core fields for sync request management
      - Support for reference tracks and preferred producers
      - Status tracking and submission details
  ...
  3. Performance
    ...
    - Optimized for status and date-based lookups
*/
