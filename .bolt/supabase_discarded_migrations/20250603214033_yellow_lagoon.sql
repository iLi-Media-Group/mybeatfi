/*
  # Fix producer revenue tracking

  1. New Columns
    - Ensure `producer_id` column exists in `sales` table
  ...
  3. Data Updates
    - Update existing sales records with producer_id from tracks
    - Create trigger to automatically set producer_id on new sales
    - Refresh sales analytics materialized view
*/
