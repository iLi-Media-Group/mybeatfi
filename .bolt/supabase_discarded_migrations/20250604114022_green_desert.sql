/*
  # Add producer_id to sales table and related functionality
  
  1. Changes
     - Adds producer_id column to sales table if it doesn't exist
     - Creates index on producer_id for performance
     - Adds RLS policy for producers to view their own sales
     - Updates existing sales records with producer_id from tracks
