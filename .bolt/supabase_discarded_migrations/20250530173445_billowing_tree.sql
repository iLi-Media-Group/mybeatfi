...
DROP POLICY IF EXISTS "Admins have full access to messages" ON chat_messages;
...
-- Update chat_rooms policies to allow room creators to delete their rooms
...
-- Add policy for admins to manage all rooms
