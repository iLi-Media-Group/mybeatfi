/*
  ...
  1. New Data
    - Creates test tracks with vocals
    - Creates two test sync proposals
    - Adds negotiation messages
    - Adds proposal files
  
  2. Changes
    - Ensures tracks have vocal fields
    - Adds test data for sync proposals
    - Creates complete proposal history
*/
