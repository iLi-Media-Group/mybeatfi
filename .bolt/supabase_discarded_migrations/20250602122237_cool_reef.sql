...
INSERT INTO compensation_settings (id, standard_rate, exclusive_rate, sync_fee_rate, holding_period, minimum_withdrawal, processing_fee)
VALUES (1, 70, 80, 85, 30, 50, 2)
...
DO $$
BEGIN
    -- Drop policies for producer_balances
    ...
    -- Drop policies for producer_payment_methods
    ...
    -- Drop policies for producer_transactions
    ...
    -- Drop policies for producer_withdrawals
    ...
    -- Drop policies for compensation_settings
...
-- Create a cron job to release pending funds daily
-- Note: This requires pg_cron extension to be enabled
-- CREATE EXTENSION IF NOT EXISTS pg_cron;
-- SELECT cron.schedule('0 0 * * *', 'SELECT release_pending_funds()');
