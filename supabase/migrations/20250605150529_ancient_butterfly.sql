/*
  # Sync Proposal Workflow Enhancements

  1. New Columns
    - Add client_status to sync_proposals table
    - Add payment_status to sync_proposals table
    - Add invoice_id to sync_proposals table
    - Add payment_date to sync_proposals table
