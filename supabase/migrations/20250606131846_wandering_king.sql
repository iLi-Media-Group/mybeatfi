/*
# Add sync proposal payment handling

1. Schema Updates
  - Add client_status, payment_status, invoice_id, and payment_date columns to sync_proposals table
  - Add constraints for client_status and payment_status

2. Functions
  - Create handle_sync_proposal_payment function to process payments for sync proposals
  - Calculate and distribute producer earnings based on compensation settings

3. Triggers
  - Add trigger on stripe_orders to handle sync proposal payments

4. Security
  - Update RLS policies for sync_proposals table
*/
