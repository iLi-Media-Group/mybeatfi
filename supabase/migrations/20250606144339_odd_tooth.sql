/*
  # Update sync_proposals table and add payment handling

  1. New Columns
    - `client_status` (text) - Tracks client's response to proposal
    - `payment_status` (text) - Tracks payment status
    - `invoice_id` (text) - Stores payment reference
    - `payment_date` (timestamptz) - Records when payment was made
  
  2. Functions
    - `handle_sync_proposal_payment()` - Processes payments and updates producer balances
  
  3. Security
    - Updated RLS policies for sync_proposals table
*/
