/*
  # Fix Sync Proposal Workflow

  1. New Columns
    - Add client_status to sync_proposals (pending, accepted, rejected)
    - Add payment_status to sync_proposals (pending, paid, failed)
    - Add invoice_id to sync_proposals
    - Add payment_date to sync_proposals
  
  2. Functions
    - Create handle_sync_proposal_payment function to process payments
    - Create trigger on stripe_orders to handle sync proposal payments
  
  3. Security
    - Update RLS policies for sync_proposals to allow client updates
*/
